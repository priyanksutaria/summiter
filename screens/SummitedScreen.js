...
const SummitedScreen = () => {
  ...
  useEffect(() => {
    ...
    console.log('Nearby Peak:', nearbyPeak.name);
  }, [showHint]);
      ...
      onPanResponderRelease: (_, gesture) => {
        ...
        if (gesture.dx > slideThreshold) {
          ...
          Animated.spring(pan.x, {
            ...
            setTimeout(() => {
              // Navigate to camera screen and pass mountain name as parameter
  ...
  return (
    <View style={styles.container}>
      {/* Background image that includes sky and snow peak */}
      <ImageBackground 
        source={require('../assets/Summiting.png')} 
        style={styles.backgroundImage}
        resizeMode="cover"
      >
        <View style={styles.contentContainer}>
          <Text style={styles.congratsTitle}>CONGRATULATIONS,</Text>
          <Text style={styles.mountainTitle}>ON SUMMITING {nearbyPeak.name.toUpperCase()}</Text>

          <Text style={styles.instructionText}>
            Make sure you capture this moment with a summit photo! Slide the below button to click
            a picture for your certificate
          </Text>
